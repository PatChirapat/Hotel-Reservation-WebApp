...
export default function ConfirmBooking() {
  ...
  // ปุ่ม PDF อัจฉริยะ: Chrome/Edge → saveAsPDF(), อื่นๆ → print()
  ...
  useEffect(() => {
    ...
    // small delay so fonts/images/layout are ready
    const timer = setTimeout(() => {
      // Directly generate a PDF (no print fallback/popups)
      saveAsPDF().catch(() => {/* ignore */});
    }, 300);
